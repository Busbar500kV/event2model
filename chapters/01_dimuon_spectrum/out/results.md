...
Resonant structure appears only after aggregating many events. Invariant mass is not an event-level property but a statistical construct derived from Lorentz-invariant constraints.
